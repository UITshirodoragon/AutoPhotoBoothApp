...
class Ui_TemplateExportView(object):
    def setupUi(self, TemplateExportView):
        ...
        TemplateExportView.resize(450, 800)
        ...
        self.thanks_text_label.setGeometry(QRect(75, 25, 300, 50))
        ...
        self.template_show_label.setGeometry(QRect(25, 100, 400, 300))
        self.template_show_label.setScaledContents(True)
        ...
        self.scan_text_label.setGeometry(QRect(25, 425, 400, 50))
        ...
        self.qr_code_image_label.setGeometry(QRect(25, 500, 400, 200))
        ...
        self.restart_button.setGeometry(QRect(25, 725, 400, 50))
        icon1 = QIcon()
