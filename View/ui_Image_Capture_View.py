...
class Ui_Image_Capture_View(object):
    def setupUi(self, Image_Capture_View):
        ...
        Image_Capture_View.resize(450, 800)
        self.next_button = QPushButton(Image_Capture_View)
        self.next_button.setObjectName(u"next_button")
        self.next_button.setGeometry(QRect(375, 25, 50, 50))
        icon = QIcon()
        ...
        self.preview_fps_label.setGeometry(QRect(25, 425, 50, 50))
        ...
        self.capture_button.setGeometry(QRect(200, 425, 50, 50))
        icon1 = QIcon()
        ...
        self.preview_image_label.setGeometry(QRect(25, 100, 400, 300))
